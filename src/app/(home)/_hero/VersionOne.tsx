...
export function VersionOne({
  ...
  const safeModalEyebrow =
    modalEyebrow || `Private Enquiry • ${safeSiteTitle}`;
      ...
      {isEditable && (
        <div className="absolute right-5 top-5 z-20 md:right-8 md:top-8">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-[10px] font-medium uppercase tracking-[0.28em] text-[#F8F8F3] backdrop-blur-md transition-all duration-300 hover:bg-white/20"
          >
            <Camera size={13} />
            Replace Image
          </button>
        ...
        {isModalOpen && (
          <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6">
            ...
            <motion.div
              ...
              className="relative z-[100000] bg-red-500 w-full max-w-md overflow-hidden rounded-2xl bg-[#F8F8F3] p-8 text-[#1A1A1A] shadow-2xl"
            >
              <button
                type="button"
                onClick={() => setIsModalOpen(false)}
